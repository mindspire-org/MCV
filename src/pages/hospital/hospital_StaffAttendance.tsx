...
export default function Pharmacy_StaffAttendance(){
  ...
  useEffect(() => {
    ...
    ;(async () => {
      try {
        ...
        setLoadErr(msg || 'Failed to load staff')
      }
    })()
  ...
  return (
    <div className="space-y-4">
      ...
      {!!loadErr && (
        <div className="rounded-md border border-rose-200 bg-rose-50 px-3 py-2 text-sm text-rose-800">{loadErr}</div>
      )}
