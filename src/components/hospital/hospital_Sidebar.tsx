...
const navTop: NavItem[] = [
  {
    to: "/hospital/workflow/dashboard",
  ...
  {
    to: "/hospital/ops/housekeeping",
    label: "Housekeeping",
    icon: Boxes,
  },
  {
    to: "/hospital/ops/utilities",
    label: "Utilities",
    icon: Activity,
  },
  {
    to: "/hospital/ops/security",
...
const groups: { label: string; icon: LucideIcon; items: NavItem[] }[] = [
  ...
  },
  {
    ...
    icon: Droplet,
    items: [
      { to: "/hospital/dialysis", label: "Dialysis", icon: Droplet },
      {
        to: "/hospital/dialysis/active",
