...
import Hospital_WorkflowDashboard from "./pages/hospital/hospital_WorkflowDashboard";
import Hospital_WorkflowList from "./pages/hospital/hospital_WorkflowList";
import Hospital_WorkflowDetail from "./pages/hospital/hospital_WorkflowDetail";
import Hospital_WorkflowNew from "./pages/hospital/hospital_WorkflowNew";
import Hospital_CqiDashboard from "./pages/hospital/cqi/Hospital_CqiDashboard";
import Hospital_CqiComplaints from "./pages/hospital/cqi/Hospital_CqiComplaints";
import Hospital_CqiIncidents from "./pages/hospital/cqi/Hospital_CqiIncidents";
import Hospital_CqiCapa from "./pages/hospital/cqi/Hospital_CqiCapa";

// Compliance & Communication
import Hospital_ComplianceLayout from "./pages/hospital/hospital_ComplianceLayout";
import Hospital_ComplianceOverview from "./pages/hospital/compliance/Hospital_ComplianceOverview";
import Hospital_ComplianceComplaints from "./pages/hospital/compliance/Hospital_ComplianceComplaints";
import Hospital_ComplianceIncidents from "./pages/hospital/compliance/Hospital_ComplianceIncidents";
import Hospital_ComplianceCapa from "./pages/hospital/compliance/Hospital_ComplianceCapa";
import Hospital_CommunicationOverview from "./pages/hospital/communication/Hospital_CommunicationOverview";
import Hospital_CommunicationNotifications from "./pages/hospital/communication/Hospital_CommunicationNotifications";
import Hospital_CommunicationAnnouncements from "./pages/hospital/communication/Hospital_CommunicationAnnouncements";
import Hospital_CommunicationFeedback from "./pages/hospital/communication/Hospital_CommunicationFeedback";
import Hospital_OpsDashboard from "./pages/hospital/ops/Hospital_OpsDashboard";
import Hospital_OpsHousekeeping from "./pages/hospital/ops/Hospital_OpsHousekeeping";
import Hospital_OpsUtilities from "./pages/hospital/ops/Hospital_OpsUtilities";
import Hospital_OpsSecurity from "./pages/hospital/ops/Hospital_OpsSecurity";
...
import Task_Login from "./pages/task/task_Login";
import Task_Router from "./pages/task/task_Router";
import Outreach_Login from "./pages/outreach/outreach_Login";
import Outreach_Portal from "./pages/outreach/outreach_Portal";

import Hospital_DialysisRouter from "./pages/hospital/hospital_DialysisRouter";

export default function App() {
  return (
    <Routes>
      <Route path="/" element={<Home />} />
      <Route path="/task/login" element={<Task_Login />} />
      <Route path="/task/*" element={<Task_Router />} />
      <Route path="/outreach/login" element={<Outreach_Login />} />
      <Route path="/outreach" element={<Outreach_Portal />} />
      ...
      <Route path="/hospital" element={<Hospital_Layout />}>
        ...
        <Route path="dialysis/*" element={<Hospital_DialysisRouter />} />
        ...
        <Route path="workflow" element={<Hospital_WorkflowList />} />
        <Route
          path="workflow/dashboard"
          element={<Hospital_WorkflowDashboard />}
        />
        <Route path="workflow/new" element={<Hospital_WorkflowNew />} />
        <Route path="workflow/:id" element={<Hospital_WorkflowDetail />} />
        <Route path="workflow/:id/edit" element={<Hospital_WorkflowNew />} />

        <Route path="cqi" element={<Hospital_CqiDashboard />} />
        <Route path="cqi/complaints" element={<Hospital_CqiComplaints />} />
        <Route path="cqi/incidents" element={<Hospital_CqiIncidents />} />
        <Route path="cqi/capa" element={<Hospital_CqiCapa />} />

        {/* Compliance & Communication */}
        <Route path="compliance" element={<Hospital_ComplianceLayout />}>
          <Route index element={<Hospital_ComplianceOverview />} />
          <Route
            path="complaints"
            element={<Hospital_ComplianceComplaints />}
          />
          <Route path="incidents" element={<Hospital_ComplianceIncidents />} />
          <Route path="capa" element={<Hospital_ComplianceCapa />} />
        </Route>

        <Route path="communication" element={<Hospital_ComplianceLayout />}>
          <Route index element={<Hospital_CommunicationOverview />} />
          <Route
            path="notifications"
            element={<Hospital_CommunicationNotifications />}
          />
          <Route
            path="announcements"
            element={<Hospital_CommunicationAnnouncements />}
          />
          <Route path="feedback" element={<Hospital_CommunicationFeedback />} />
        </Route>

        <Route path="ops" element={<Hospital_OpsDashboard />} />
        <Route path="ops/housekeeping" element={<Hospital_OpsHousekeeping />} />
        <Route path="ops/utilities" element={<Hospital_OpsUtilities />} />
        <Route path="ops/security" element={<Hospital_OpsSecurity />} />
        ...
        <Route
          path="equipment/breakdown-register"
          element={<Hospital_EquipmentBreakdownRegister />}
        />
        <Route
          path="equipment/condemnation-register"
          element={<Hospital_EquipmentCondemnationRegister />}
        />
        ...
        <Route
          ...
          element={<Hospital_SidebarPermissions />}
        />
        ...
        <Route
          ...
          element={<Hospital_CorporateCompanies />}
        />
        <Route
          path="corporate/rate-rules"
          element={<Hospital_CorporateRateRules />}
        />
        <Route
          path="corporate/transactions"
          element={<Hospital_CorporateTransactions />}
        />
        <Route path="corporate/claims" element={<Hospital_CorporateClaims />} />
        <Route
          path="corporate/payments"
          element={<Hospital_CorporatePayments />}
        />
        <Route
          path="corporate/reports"
          element={<Hospital_CorporateReports />}
        />
      </Route>
      <Route path="/aesthetic" element={<Aesthetic_Layout />}>
        ...
        <Route
          ...
          element={<Aesthetic_TokenGeneratorPage />}
        />
        ...
        <Route
          ...
          element={<Aesthetic_UserManagementPage />}
        />
        <Route
          path="sidebar-permissions"
          element={<Aesthetic_SidebarPermissions />}
        />
        <Route
          path="procedure-catalog"
          element={<Aesthetic_ProcedureCatalog />}
        />
        <Route
          path="consent-templates"
          element={<Aesthetic_ConsentTemplates />}
        />
        <Route
          path="staff-attendance"
          element={<Aesthetic_StaffAttendance />}
        />
        <Route
          path="staff-management"
          element={<Aesthetic_StaffManagement />}
        />
      ...
      <Route path="/diagnostic" element={<Diagnostic_Layout />}>
        ...
        <Route
          ...
          element={<Diagnostic_ReportGenerator />}
        />
        <Route path="referrals" element={<Diagnostic_Referrals />} />
        <Route
          path="sidebar-permissions"
          element={<Diagnostic_SidebarPermissions />}
        />
      ...
      <Route path="/pharmacy" element={<Pharmacy_Layout />}>
        ...
        <Route
          path="inventory/add-invoice"
          element={<Pharmacy_AddInvoicePage />}
        />
        <Route
          path="inventory/edit-invoice/:id"
          element={<Pharmacy_AddInvoicePage />}
        />
      ...
      <Route path="/finance" element={<Finance_Layout />}>
        ...
        <Route
          path="sidebar-permissions"
          element={<Finance_SidebarPermissions />}
        />
      ...
      <Route path="/reception" element={<Reception_Layout />}>
        ...
        <Route
          path="sidebar-permissions"
          element={<Reception_SidebarPermissions />}
        />
        <Route
          path="diagnostic/token-generator"
          element={<Diagnostic_TokenGenerator />}
        />
        <Route
          path="diagnostic/sample-tracking"
          element={<Diagnostic_SampleTracking />}
        />
