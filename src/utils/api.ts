  ...
  try {
    if (path) {
      if (path.startsWith("/reception"))
        return (
          localStorage.getItem("reception.token") ||
      ...
      if (path.startsWith("/lab"))
        return (
          ...
          localStorage.getItem("aesthetic.token") ||
          localStorage.getItem("token") ||
          ""
        );
      if (path.startsWith("/aesthetic"))
        return (
          localStorage.getItem("aesthetic.token") ||
          localStorage.getItem("token") ||
          ""
...
export const diagnosticApi = {
  ...
  deleteSidebarRole: (role: string) =>
    api(`/diagnostic/sidebar-roles/${encodeURIComponent(role)}`, {
      method: "DELETE",
    }),
  ...
  updateSidebarPermissions: (
    ...
    api(`/diagnostic/sidebar-permissions/${encodeURIComponent(role)}`, {
      method: "PUT",
      body: JSON.stringify(data),
    }),
  resetSidebarPermissions: (role: string) =>
    api(`/diagnostic/sidebar-permissions/${encodeURIComponent(role)}/reset`, {
      method: "POST",
    }),
};
...
export const receptionApi = {
  ...
  deleteSidebarRole: (role: string) =>
    api(`/reception/sidebar-roles/${encodeURIComponent(role)}`, {
      method: "DELETE",
    }),
  listSidebarPermissions: (role?: string) =>
    role
  ...
  updateSidebarPermissions: (
    ...
    api(`/reception/sidebar-permissions/${encodeURIComponent(role)}`, {
      method: "PUT",
      body: JSON.stringify(data),
    }),
  resetSidebarPermissions: (role: string) =>
    api(`/reception/sidebar-permissions/${encodeURIComponent(role)}/reset`, {
      method: "POST",
    }),
};
...
export async function api(path: string, init?: RequestInit) {
  ...
  if (!token && adminKey && !headers["x-admin-key"])
...
async function cachedApi(
  path: string,
  init?: RequestInit,
  opts?: { ttlMs?: number; cacheKey?: string; forceRefresh?: boolean },
) {
...
export const pharmacyApi = {
  ...
  updateCompany: (
    ...
    api(`/pharmacy/companies/${id}`, {
      method: "PUT",
      body: JSON.stringify(data),
    }),
  deleteCompany: (id: string) =>
    api(`/pharmacy/companies/${id}`, { method: "DELETE" }),
  listSupplierCompanies: (supplierId: string) =>
    api(`/pharmacy/suppliers/${supplierId}/companies`),
  assignSupplierCompanies: (
    supplierId: string,
    data: { companyIds?: string[]; unassignIds?: string[] },
  ) =>
    api(`/pharmacy/suppliers/${supplierId}/companies`, {
      method: "POST",
      body: JSON.stringify(data),
  ...
  searchMedicines: async (q?: string, limit?: number) => {
    ...
    const res: any = await api(
      `/pharmacy/inventory${qs.toString() ? `?${qs}` : ""}`,
    );
    const items: any[] = res?.items ?? res ?? [];
    return {
      suggestions: items.map((it: any) => ({
        id: String(it._id || it.key || it.name || ""),
        name: String(it.name || ""),
      })),
    };
  },
  ...
  updateStaffEarning: (
    ...
    api(`/pharmacy/staff-earnings/${id}`, {
      method: "PUT",
      body: JSON.stringify(data),
    }),
  deleteStaffEarning: (id: string) =>
    api(`/pharmacy/staff-earnings/${id}`, { method: "DELETE" }),
  ...
  getHoldSale: (id: string) =>
    api(`/pharmacy/hold-sales/${encodeURIComponent(id)}`),
  createHoldSale: (data: {
  ...
  deleteHoldSale: (id: string) =>
    api(`/pharmacy/hold-sales/${encodeURIComponent(id)}`, { method: "DELETE" }),
  ...
  loginUser: (username: string, password: string) =>
    api("/pharmacy/users/login", {
      method: "POST",
      body: JSON.stringify({ username, password }),
    }),
  logoutUser: (username?: string) =>
    api("/pharmacy/users/logout", {
      method: "POST",
  ...
  createSidebarRole: (
    ...
    api("/pharmacy/sidebar-roles", {
      method: "POST",
      body: JSON.stringify({ role, permissions }),
    }),
  deleteSidebarRole: (role: string) =>
    api(`/pharmacy/sidebar-roles/${encodeURIComponent(role)}`, {
      method: "DELETE",
    }),
  listSidebarPermissions: (role?: string) =>
    role
  ...
  updatePurchaseDraft: (id: string, data: any) =>
    api(`/pharmacy/purchase-drafts/${id}`, {
      method: "PUT",
      body: JSON.stringify(data),
    }),
  ...
  listInventoryCached: (
    ...
    if (params?.limit != null) qs.set("limit", String(params.limit));
    const s = qs.toString();
    return cachedApi(`/pharmacy/inventory${s ? `?${s}` : ""}`, undefined, {
      ttlMs: opts?.ttlMs,
      forceRefresh: opts?.forceRefresh,
    });
  },
  listInventoryFilteredCached: (
    params: {
      status: "low" | "out" | "expiring";
      search?: string;
      page?: number;
    ...
    const s = qs.toString();
    return cachedApi(
      `/pharmacy/inventory/filter${s ? `?${s}` : ""}`,
      undefined,
      { ttlMs: opts?.ttlMs, forceRefresh: opts?.forceRefresh },
    );
  },
  inventorySummaryCached: (
    ...
    const s = qs.toString();
    return cachedApi(
      `/pharmacy/inventory/summary${s ? `?${s}` : ""}`,
      undefined,
      { ttlMs: opts?.ttlMs, forceRefresh: opts?.forceRefresh },
    );
  },
  purchasesSummaryCached: (
    ...
    const s = qs.toString();
    return cachedApi(
      `/pharmacy/purchases/summary${s ? `?${s}` : ""}`,
      undefined,
      { ttlMs: opts?.ttlMs, forceRefresh: opts?.forceRefresh },
    );
  },
  salesSummaryCached: (
    ...
    if (params?.to) qs.set("to", params.to);
    const s = qs.toString();
    return cachedApi(`/pharmacy/sales/summary${s ? `?${s}` : ""}`, undefined, {
      ttlMs: opts?.ttlMs,
      forceRefresh: opts?.forceRefresh,
    });
  },
  listSalesCached: (
    ...
    if (params?.limit != null) qs.set("limit", String(params.limit));
    const s = qs.toString();
    return cachedApi(`/pharmacy/sales${s ? `?${s}` : ""}`, undefined, {
      ttlMs: opts?.ttlMs,
      forceRefresh: opts?.forceRefresh,
    });
  },
...
export const aestheticApi = {
  ...
  updateSettings: (data: any) =>
    api("/aesthetic/settings", { method: "PUT", body: JSON.stringify(data) }),
  login: (username: string, password: string) =>
    api("/aesthetic/login", {
      method: "POST",
      body: JSON.stringify({ username, password }),
  ...
  createStaff: (data: any) =>
    api("/aesthetic/staff", { method: "POST", body: JSON.stringify(data) }),
  updateStaff: (id: string, data: any) =>
    api(`/aesthetic/staff/${id}`, {
      method: "PUT",
      body: JSON.stringify(data),
    }),
  deleteStaff: (id: string) =>
    api(`/aesthetic/staff/${id}`, { method: "DELETE" }),

  // Shifts
  listShifts: () => api("/aesthetic/shifts"),
  createShift: (data: any) =>
    api("/aesthetic/shifts", { method: "POST", body: JSON.stringify(data) }),
  updateShift: (id: string, data: any) =>
    api(`/aesthetic/shifts/${id}`, {
      method: "PUT",
      body: JSON.stringify(data),
    }),
  deleteShift: (id: string) =>
    api(`/aesthetic/shifts/${id}`, { method: "DELETE" }),
  ...
  updateStaffEarning: (
    ...
    api(`/aesthetic/staff-earnings/${id}`, {
      method: "PUT",
      body: JSON.stringify(data),
    }),
  deleteStaffEarning: (id: string) =>
    api(`/aesthetic/staff-earnings/${id}`, { method: "DELETE" }),
  ...
  createSupplier: (data: any) =>
    api("/aesthetic/suppliers", { method: "POST", body: JSON.stringify(data) }),
  updateSupplier: (id: string, data: any) =>
    api(`/aesthetic/suppliers/${id}`, {
      method: "PUT",
      body: JSON.stringify(data),
    }),
  deleteSupplier: (id: string) =>
    api(`/aesthetic/suppliers/${id}`, { method: "DELETE" }),
  recordSupplierPayment: (
    id: string,
    data: {
      amount: number;
    ...
    api(`/aesthetic/suppliers/${id}/payment`, {
      method: "POST",
      body: JSON.stringify(data),
    }),
  listSupplierPurchases: (id: string) =>
    api(`/aesthetic/suppliers/${id}/purchases`),
  ...
  createExpense: (data: any) =>
    api("/aesthetic/expenses", { method: "POST", body: JSON.stringify(data) }),
  deleteExpense: (id: string) =>
    api(`/aesthetic/expenses/${id}`, { method: "DELETE" }),
  expensesSummary: (params?: { from?: string; to?: string }) => {
    const qs = new URLSearchParams();
    if (params?.from) qs.set("from", params.from);
    if (params?.to) qs.set("to", params.to);
  ...
  createPurchase: (data: any) =>
    api("/aesthetic/purchases", { method: "POST", body: JSON.stringify(data) }),
  deletePurchase: (id: string) =>
    api(`/aesthetic/purchases/${id}`, { method: "DELETE" }),
  purchasesSummary: (params?: { from?: string; to?: string }) => {
    const qs = new URLSearchParams();
    if (params?.from) qs.set("from", params.from);
    if (params?.to) qs.set("to", params.to);
  ...
  createReturn: (data: any) =>
    api("/aesthetic/returns", { method: "POST", body: JSON.stringify(data) }),
  ...
  createUser: (data: any) =>
    api("/aesthetic/users", { method: "POST", body: JSON.stringify(data) }),
  updateUser: (id: string, data: any) =>
    api(`/aesthetic/users/${id}`, {
      method: "PUT",
      body: JSON.stringify(data),
    }),
  deleteUser: (id: string) =>
    api(`/aesthetic/users/${id}`, { method: "DELETE" }),
  ...
  createSidebarRole: (
    ...
    api("/aesthetic/sidebar-roles", {
      method: "POST",
      body: JSON.stringify({ role, permissions }),
    }),
  deleteSidebarRole: (role: string) =>
    api(`/aesthetic/sidebar-roles/${encodeURIComponent(role)}`, {
      method: "DELETE",
    }),
  listSidebarPermissions: (role?: string) =>
    role
  ...
  updateSidebarPermissions: (
    ...
    api(`/aesthetic/sidebar-permissions/${encodeURIComponent(role)}`, {
      method: "PUT",
      body: JSON.stringify(data),
    }),
  resetSidebarPermissions: (role: string) =>
    api(`/aesthetic/sidebar-permissions/${encodeURIComponent(role)}/reset`, {
      method: "POST",
    }),
  ...
  createPurchaseDraft: (data: any) =>
    api("/aesthetic/purchase-drafts", {
      method: "POST",
      body: JSON.stringify(data),
    }),
  approvePurchaseDraft: (id: string) =>
    api(`/aesthetic/purchase-drafts/${id}/approve`, { method: "POST" }),
  deletePurchaseDraft: (id: string) =>
    api(`/aesthetic/purchase-drafts/${id}`, { method: "DELETE" }),
  ...
  deleteInventoryItem: (key: string) =>
    api(`/aesthetic/inventory/${encodeURIComponent(key)}`, {
      method: "DELETE",
    }),
  updateInventoryItem: (key: string, data: any) =>
    api(`/aesthetic/inventory/${encodeURIComponent(key)}`, {
  ...
  searchMedicines: async (q?: string, limit?: number) => {
    ...
    qs.set("limit", String(limit || 20));
    const res: any = await api(
      `/aesthetic/inventory${qs.toString() ? `?${qs}` : ""}`,
    );
    const items: any[] = res?.items ?? res ?? [];
    return {
      suggestions: items.map((it: any) => ({
  ...
  markNotificationRead: (id: string) =>
    api(`/aesthetic/notifications/${id}/read`, { method: "POST" }),
  markAllNotificationsRead: () =>
    api("/aesthetic/notifications/read-all", { method: "POST" }),
  deleteNotification: (id: string) =>
    api(`/aesthetic/notifications/${id}`, { method: "DELETE" }),
  generateNotifications: () =>
    api("/aesthetic/notifications/generate", { method: "POST" }),
  ...
  createConsentTemplate: (data: {
    ...
    api("/aesthetic/consent-templates", {
      method: "POST",
      body: JSON.stringify(data),
    }),
  updateConsentTemplate: (
    ...
    api(`/aesthetic/consent-templates/${id}`, {
      method: "PUT",
      body: JSON.stringify(patch),
    }),
  deleteConsentTemplate: (id: string) =>
    api(`/aesthetic/consent-templates/${id}`, { method: "DELETE" }),
  ...
  createProcedureCatalog: (data: {
    ...
    api("/aesthetic/procedure-catalog", {
      method: "POST",
      body: JSON.stringify(data),
    }),
  updateProcedureCatalog: (
    ...
    api(`/aesthetic/procedure-catalog/${id}`, {
      method: "PUT",
      body: JSON.stringify(patch),
    }),
  deleteProcedureCatalog: (id: string) =>
    api(`/aesthetic/procedure-catalog/${id}`, { method: "DELETE" }),

  // Procedure Sessions
  listProcedureSessions: (params?: {
    search?: string;
    labPatientId?: string;
    patientMrn?: string;
    phone?: string;
  ...
  createProcedureSession: (data: {
    ...
    api("/aesthetic/procedure-sessions", {
      method: "POST",
      body: JSON.stringify(data),
    }),
  updateProcedureSession: (
    ...
    api(`/aesthetic/procedure-sessions/${id}`, {
      method: "PUT",
      body: JSON.stringify(patch),
    }),
  deleteProcedureSession: (id: string) =>
    api(`/aesthetic/procedure-sessions/${id}`, { method: "DELETE" }),

  completeProcedure: (data: { patientMrn: string; procedureId: string }) =>
    api("/aesthetic/procedure-sessions/complete-procedure", {
      method: "POST",
      body: JSON.stringify(data),
    }),

  // Procedure Session Payments & Next Visit
  addProcedureSessionPayment: (
    id: string,
    data: { amount: number; method?: string; dateIso?: string; note?: string },
  ) =>
    api(`/aesthetic/procedure-sessions/${id}/payments`, {
      method: "POST",
      body: JSON.stringify(data),
    }),
  getProcedureSessionPayments: (id: string) =>
    api(`/aesthetic/procedure-sessions/${id}/payments`),
  setProcedureSessionNextVisit: (id: string, nextVisitDate: string) =>
    api(`/aesthetic/procedure-sessions/${id}/next-visit`, {
      method: "PUT",
  ...
  updateDoctor: (
    ...
    api(`/aesthetic/doctors/${id}`, {
      method: "PUT",
      body: JSON.stringify(patch),
    }),
  deleteDoctor: (id: string) =>
    api(`/aesthetic/doctors/${id}`, { method: "DELETE" }),
};
...
export const labApi = {
  ...
  updateStaffEarning: (
    ...
    api(`/lab/staff-earnings/${id}`, {
      method: "PUT",
      body: JSON.stringify(data),
    }),
  deleteStaffEarning: (id: string) =>
    api(`/lab/staff-earnings/${id}`, { method: "DELETE" }),
  ...
  createSidebarRole: (
    ...
    api("/lab/sidebar-roles", {
      method: "POST",
      body: JSON.stringify({ role, permissions }),
    }),
  deleteSidebarRole: (role: string) =>
    api(`/lab/sidebar-roles/${encodeURIComponent(role)}`, { method: "DELETE" }),
  listSidebarPermissions: (role?: string) =>
    role
...
export const hospitalApi = {
  ...
  listWorkflowItems: (params?: {
    ...
    if (params?.limit != null) qs.set("limit", String(params.limit));
    const s = qs.toString();
    return api(`/hospital/workflow${s ? `?${s}` : ""}`);
  },
  createWorkflowItem: (data: any) =>
    api("/hospital/workflow", { method: "POST", body: JSON.stringify(data) }),
  getWorkflowItem: (id: string) => api(`/hospital/workflow/${id}`),
  updateWorkflowItem: (id: string, data: any) =>
    api(`/hospital/workflow/${id}`, {
      method: "PUT",
      body: JSON.stringify(data),
    }),
  deleteWorkflowItem: (id: string) =>
    api(`/hospital/workflow/${id}`, { method: "DELETE" }),
  addWorkflowComment: (
    id: string,
    data: { text: string; internal?: boolean },
  ) =>
    api(`/hospital/workflow/${id}/comments`, {
      method: "POST",
      body: JSON.stringify(data),
    }),
  createWorkflowTask: (id: string, data: any) =>
    api(`/hospital/workflow/${id}/tasks`, {
      method: "POST",
      body: JSON.stringify(data),
    }),
  updateWorkflowTask: (taskId: string, data: any) =>
    api(`/hospital/workflow/tasks/${taskId}`, {
      method: "PUT",
      body: JSON.stringify(data),
    }),
  deleteWorkflowTask: (taskId: string) =>
    api(`/hospital/workflow/tasks/${taskId}`, { method: "DELETE" }),
  getWorkflowDashboardSummary: () =>
    api("/hospital/workflow/dashboard/summary"),
  getWorkflowCqiStats: () => api("/hospital/workflow/cqi/stats"),
  getWorkflowOperationsStats: () => api("/hospital/workflow/operations/stats"),

  // Workflow item attachments
  uploadWorkflowItemAttachment: (id: string, file: File) => {
    const formData = new FormData();
    formData.append("file", file);
    return api(`/hospital/workflow/${id}/attachments`, {
      method: "POST",
      body: formData,
      // Don't set Content-Type header for FormData
    });
  },
  deleteWorkflowItemAttachment: (id: string, attachmentId: string) =>
    api(`/hospital/workflow/${id}/attachments/${attachmentId}`, {
      method: "DELETE",
    }),

  // Workflow task attachments
  uploadWorkflowTaskAttachment: (taskId: string, file: File) => {
    const formData = new FormData();
    formData.append("file", file);
    return api(`/hospital/workflow/tasks/${taskId}/attachments`, {
      method: "POST",
      body: formData,
    });
  },
  deleteWorkflowTaskAttachment: (taskId: string, attachmentId: string) =>
    api(`/hospital/workflow/tasks/${taskId}/attachments/${attachmentId}`, {
      method: "DELETE",
    }),

  // Maintenance (Assets + Plans + Auto Tasks)
  maintenanceListCategories: (params?: { active?: boolean }) => {
    const qs = new URLSearchParams();
    if (params?.active != null) qs.set("active", String(params.active));
    const s = qs.toString();
    return api(`/hospital/maintenance/categories${s ? `?${s}` : ""}`);
  },
  maintenanceCreateCategory: (data: any) =>
    api("/hospital/maintenance/categories", {
      method: "POST",
      body: JSON.stringify(data),
    }),
  maintenanceUpdateCategory: (id: string, data: any) =>
    api(`/hospital/maintenance/categories/${encodeURIComponent(id)}`, {
      method: "PUT",
      body: JSON.stringify(data),
    }),
  maintenanceDeleteCategory: (id: string) =>
    api(`/hospital/maintenance/categories/${encodeURIComponent(id)}`, {
      method: "DELETE",
    }),

  maintenanceListAssets: (params?: {
    q?: string;
    categoryId?: string;
    ...
    if (params?.limit != null) qs.set("limit", String(params.limit));
    const s = qs.toString();
    return api(`/hospital/maintenance/assets${s ? `?${s}` : ""}`);
  },
  maintenanceCreateAsset: (data: any) =>
    api("/hospital/maintenance/assets", {
      method: "POST",
      body: JSON.stringify(data),
    }),
  maintenanceUpdateAsset: (id: string, data: any) =>
    api(`/hospital/maintenance/assets/${encodeURIComponent(id)}`, {
      method: "PUT",
      body: JSON.stringify(data),
    }),
  maintenanceDeleteAsset: (id: string) =>
    api(`/hospital/maintenance/assets/${encodeURIComponent(id)}`, {
      method: "DELETE",
    }),

  maintenanceListPlans: (params?: {
    assetId?: string;
    role?: string;
    enabled?: boolean;
    page?: number;
    ...
    if (params?.limit != null) qs.set("limit", String(params.limit));
    const s = qs.toString();
    return api(`/hospital/maintenance/plans${s ? `?${s}` : ""}`);
  },
  maintenanceCreatePlan: (data: any) =>
    api("/hospital/maintenance/plans", {
      method: "POST",
      body: JSON.stringify(data),
    }),
  maintenanceUpdatePlan: (id: string, data: any) =>
    api(`/hospital/maintenance/plans/${encodeURIComponent(id)}`, {
      method: "PUT",
      body: JSON.stringify(data),
    }),
  maintenanceDeletePlan: (id: string) =>
    api(`/hospital/maintenance/plans/${encodeURIComponent(id)}`, {
      method: "DELETE",
    }),

  maintenanceListTasks: (params?: {
    from?: string;
    to?: string;
    date?: string;
    ...
    if (params?.assignedToStaffId)
      qs.set("assignedToStaffId", params.assignedToStaffId);
    if (params?.page != null) qs.set("page", String(params.page));
    if (params?.limit != null) qs.set("limit", String(params.limit));
    const s = qs.toString();
    return api(`/hospital/maintenance/tasks${s ? `?${s}` : ""}`);
  },
  maintenanceUpdateTask: (id: string, data: any) =>
    api(`/hospital/maintenance/tasks/${encodeURIComponent(id)}`, {
      method: "PUT",
      body: JSON.stringify(data),
    }),
  maintenanceGenerateTasks: (data?: {
    dateIso?: string;
    planId?: string;
    dryRun?: boolean;
  }) =>
    api("/hospital/maintenance/tasks/generate", {
      method: "POST",
      body: JSON.stringify(data || {}),
    }),
  maintenanceReassignTasks: (data: {
    fromStaffId: string;
    toStaffId: string;
    dateIso?: string;
    includeDone?: boolean;
  }) =>
    api("/hospital/maintenance/tasks/reassign", {
      method: "POST",
      body: JSON.stringify(data),
    }),

  maintenanceListServiceLogs: (params?: {
    assetId?: string;
    from?: string;
    to?: string;
    page?: number;
    ...
    if (params?.limit != null) qs.set("limit", String(params.limit));
    const s = qs.toString();
    return api(`/hospital/maintenance/service-logs${s ? `?${s}` : ""}`);
  },
  maintenanceCreateServiceLog: (assetId: string, data: any) =>
    api(
      `/hospital/maintenance/assets/${encodeURIComponent(assetId)}/service-logs`,
      { method: "POST", body: JSON.stringify(data) },
    ),

  // Store Management
  storeListCategories: (params?: {
    q?: string;
    active?: boolean;
    page?: number;
    limit?: number;
  ...
  storeCreateCategory: (data: {
    name: string;
    description?: string;
    active?: boolean;
  }) =>
    api("/hospital/store/categories", {
      method: "POST",
      body: JSON.stringify(data),
    }),
  storeUpdateCategory: (id: string, data: any) =>
    api(`/hospital/store/categories/${id}`, {
      method: "PUT",
      body: JSON.stringify(data),
    }),
  storeDeleteCategory: (id: string) =>
    api(`/hospital/store/categories/${id}`, { method: "DELETE" }),

  storeListUnits: (params?: {
    q?: string;
    active?: boolean;
    page?: number;
    limit?: number;
  ...
  storeCreateUnit: (data: { name: string; abbr?: string; active?: boolean }) =>
    api("/hospital/store/units", {
      method: "POST",
      body: JSON.stringify(data),
    }),
  storeUpdateUnit: (id: string, data: any) =>
    api(`/hospital/store/units/${id}`, {
      method: "PUT",
      body: JSON.stringify(data),
    }),
  storeDeleteUnit: (id: string) =>
    api(`/hospital/store/units/${id}`, { method: "DELETE" }),

  storeListLocations: (params?: {
    q?: string;
    active?: boolean;
    page?: number;
    limit?: number;
  ...
  storeCreateLocation: (data: {
    name: string;
    description?: string;
    active?: boolean;
  }) =>
    api("/hospital/store/locations", {
      method: "POST",
      body: JSON.stringify(data),
    }),
  storeUpdateLocation: (id: string, data: any) =>
    api(`/hospital/store/locations/${id}`, {
      method: "PUT",
      body: JSON.stringify(data),
    }),
  storeDeleteLocation: (id: string) =>
    api(`/hospital/store/locations/${id}`, { method: "DELETE" }),

  storeListItems: (params?: {
    q?: string;
    categoryId?: string;
    active?: boolean;
    page?: number;
  ...
  storeCreateItem: (data: any) =>
    api("/hospital/store/items", {
      method: "POST",
      body: JSON.stringify(data),
    }),
  storeUpdateItem: (id: string, data: any) =>
    api(`/hospital/store/items/${id}`, {
      method: "PUT",
      body: JSON.stringify(data),
    }),
  storeDeleteItem: (id: string) =>
    api(`/hospital/store/items/${id}`, { method: "DELETE" }),
  ...
  storeReceive: (data: any) =>
    api("/hospital/store/receive", {
      method: "POST",
      body: JSON.stringify(data),
    }),
  storeIssue: (data: any) =>
    api("/hospital/store/issue", {
      method: "POST",
      body: JSON.stringify(data),
    }),
  storeTransfer: (data: any) =>
    api("/hospital/store/transfer", {
      method: "POST",
      body: JSON.stringify(data),
    }),
  storeAdjust: (data: any) =>
    api("/hospital/store/adjust", {
      method: "POST",
      body: JSON.stringify(data),
    }),
  ...
  // Dialysis
  dialysisUpsertPatient: (data: { patientId: string; mrn?: string }) =>
    api("/hospital/dialysis/patients", {
      method: "POST",
      body: JSON.stringify(data),
    }),
  dialysisListActivePatients: (params?: { q?: string; limit?: number }) => {
    const qs = new URLSearchParams();
    if (params?.q) qs.set("q", params.q);
    if (params?.limit != null) qs.set("limit", String(params.limit));
    const s = qs.toString();
    return api(`/hospital/dialysis/patients${s ? `?${s}` : ""}`);
  },
  dialysisGetPatient: (dialysisPatientId: string) =>
    api(`/hospital/dialysis/patients/${encodeURIComponent(dialysisPatientId)}`),
  dialysisRecordScreening: (dialysisPatientId: string, data: any) =>
    api(
      `/hospital/dialysis/patients/${encodeURIComponent(dialysisPatientId)}/screening`,
      { method: "PUT", body: JSON.stringify(data) },
    ),
  dialysisApprove: (dialysisPatientId: string, data: any) =>
    api(
      `/hospital/dialysis/patients/${encodeURIComponent(dialysisPatientId)}/approval`,
      { method: "PUT", body: JSON.stringify(data) },
    ),
  dialysisCreatePlan: (dialysisPatientId: string, data: any) =>
    api(
      `/hospital/dialysis/patients/${encodeURIComponent(dialysisPatientId)}/plan`,
      { method: "POST", body: JSON.stringify(data) },
    ),
  dialysisListPlans: (dialysisPatientId: string) =>
    api(
      `/hospital/dialysis/patients/${encodeURIComponent(dialysisPatientId)}/plans`,
    ),

  dialysisScheduleSession: (dialysisPatientId: string, data: any) =>
    api(
      `/hospital/dialysis/patients/${encodeURIComponent(dialysisPatientId)}/sessions`,
      { method: "POST", body: JSON.stringify(data) },
    ),
  dialysisListSessions: (params?: {
    ...
    const qs = new URLSearchParams();
    if (params?.dialysisPatientId)
      qs.set("dialysisPatientId", params.dialysisPatientId);
    ...
    if (params?.limit != null) qs.set("limit", String(params.limit));
    const s = qs.toString();
    return api(`/hospital/dialysis/sessions${s ? `?${s}` : ""}`);
  },
  dialysisGetSession: (sessionId: string) =>
    api(`/hospital/dialysis/sessions/${encodeURIComponent(sessionId)}`),
  dialysisStartSession: (sessionId: string, data: any) =>
    api(`/hospital/dialysis/sessions/${encodeURIComponent(sessionId)}/start`, {
      method: "POST",
      body: JSON.stringify(data),
    }),
  dialysisAddMonitoring: (sessionId: string, data: any) =>
    api(
      `/hospital/dialysis/sessions/${encodeURIComponent(sessionId)}/monitoring`,
      { method: "POST", body: JSON.stringify(data) },
    ),
  dialysisListMonitoring: (sessionId: string, params?: { limit?: number }) => {
    const qs = new URLSearchParams();
    if (params?.limit != null) qs.set("limit", String(params.limit));
    const s = qs.toString();
    return api(
      `/hospital/dialysis/sessions/${encodeURIComponent(sessionId)}/monitoring${s ? `?${s}` : ""}`,
    );
  },
  dialysisListSessionConsumables: (
    sessionId: string,
    params?: { limit?: number },
  ) => {
    const qs = new URLSearchParams();
    ...
    const s = qs.toString();
    return api(
      `/hospital/dialysis/sessions/${encodeURIComponent(sessionId)}/consumables${s ? `?${s}` : ""}`,
    );
  },
  dialysisCompleteSession: (sessionId: string, data: any) =>
    api(
      `/hospital/dialysis/sessions/${encodeURIComponent(sessionId)}/complete`,
      { method: "POST", body: JSON.stringify(data) },
    ),
  dialysisGetBilling: (sessionId: string) =>
    api(`/hospital/dialysis/sessions/${encodeURIComponent(sessionId)}/billing`),

  dialysisReportPatientHistory: (params: {
    dialysisPatientId?: string;
    mrn?: string;
  }) => {
    const qs = new URLSearchParams();
    ...
    if (params?.mrn) qs.set("mrn", params.mrn);
    const s = qs.toString();
    return api(`/hospital/dialysis/reports/patient-history${s ? `?${s}` : ""}`);
  },
  dialysisReportSessionsCompleted: (params?: {
    from?: string;
    to?: string;
  }) => {
    const qs = new URLSearchParams();
    ...
    const s = qs.toString();
    return api(
      `/hospital/dialysis/reports/sessions-completed${s ? `?${s}` : ""}`,
    );
  },
  dialysisReportConsumablesUsed: (params?: {
    from?: string;
    to?: string;
    mrn?: string;
    itemId?: string;
    ...
    const s = qs.toString();
    return api(
      `/hospital/dialysis/reports/consumables-used${s ? `?${s}` : ""}`,
    );
  },
  // Masters
  ...
  applyDoctorWeeklyPattern: (data: {
    ...
    api("/hospital/doctor-schedules/weekly-pattern", {
      method: "POST",
      body: JSON.stringify(data),
    }),
  ...
  createSidebarRole: (
    ...
    api("/hospital/sidebar-roles", {
      method: "POST",
      body: JSON.stringify({ role, permissions }),
    }),
  deleteSidebarRole: (role: string) =>
    api(`/hospital/sidebar-roles/${encodeURIComponent(role)}`, {
      method: "DELETE",
    }),
  listSidebarPermissions: (role?: string) =>
    role
  ...
  updateSidebarPermissions: (
    ...
    api(`/hospital/sidebar-permissions/${encodeURIComponent(role)}`, {
      method: "PUT",
      body: JSON.stringify(data),
    }),
  resetSidebarPermissions: (role: string) =>
    api(`/hospital/sidebar-permissions/${encodeURIComponent(role)}/reset`, {
      method: "POST",
    }),
  ...
  updateAppointmentStatus: (
    ...
    api(`/hospital/appointments/${id}/status`, {
      method: "PATCH",
      body: JSON.stringify({ status }),
    }),
  deleteAppointment: (id: string) =>
    api(`/hospital/appointments/${id}`, { method: "DELETE" }),
  convertAppointmentToToken: (id: string) =>
    api(`/hospital/appointments/${id}/convert-to-token`, { method: "POST" }),

  // Staff
  listStaff: () => api("/hospital/staff"),
  listShifts: () => api("/hospital/shifts"),
  fetchBiometricNow: () =>
    api("/hospital/staff/biometric/fetch", { method: "POST" }),
  listBiometricDeviceUsers: () => api("/hospital/staff/biometric/device-users"),
  connectStaffBiometric: (
    id: string,
    data: { enrollId: string; deviceId?: string },
  ) =>
    api(`/hospital/staff/${id}/biometric/connect`, {
      method: "POST",
      body: JSON.stringify(data),
    }),
  createShift: (data: any) =>
    api("/hospital/shifts", { method: "POST", body: JSON.stringify(data) }),
  updateShift: (id: string, data: any) =>
    api(`/hospital/shifts/${id}`, {
      method: "PUT",
      body: JSON.stringify(data),
    }),
  deleteShift: (id: string) =>
    api(`/hospital/shifts/${id}`, { method: "DELETE" }),
  listAttendance: (params?: {
    date?: string;
    from?: string;
    to?: string;
  ...
  upsertAttendance: (data: any) =>
    api("/hospital/attendance", { method: "POST", body: JSON.stringify(data) }),
  createStaff: (data: any) =>
  ...
  updateStaffEarning: (
    ...
    api(`/hospital/staff-earnings/${id}`, {
      method: "PUT",
      body: JSON.stringify(data),
    }),
  deleteStaffEarning: (id: string) =>
    api(`/hospital/staff-earnings/${id}`, { method: "DELETE" }),
  ...
  updateFloor: (id: string, data: { name?: string; number?: string }) =>
    api(`/hospital/floors/${id}`, {
      method: "PUT",
      body: JSON.stringify(data),
    }),
  deleteFloor: (id: string) =>
    api(`/hospital/floors/${id}`, { method: "DELETE" }),
  ...
  updateRoom: (id: string, data: { name?: string; floorId?: string }) =>
    api(`/hospital/rooms/${id}`, { method: "PUT", body: JSON.stringify(data) }),
  deleteRoom: (id: string) =>
    api(`/hospital/rooms/${id}`, { method: "DELETE" }),
  ...
  updateWard: (id: string, data: { name?: string; floorId?: string }) =>
    api(`/hospital/wards/${id}`, { method: "PUT", body: JSON.stringify(data) }),
  deleteWard: (id: string) =>
    api(`/hospital/wards/${id}`, { method: "DELETE" }),
  listBeds: (params?: {
    floorId?: string;
  ...
  updateBed: (
    id: string,
    data: { label?: string; charges?: number; category?: string },
  ) =>
  ...
  createEquipment: (data: any) =>
    api("/hospital/equipment", { method: "POST", body: JSON.stringify(data) }),
  updateEquipment: (id: string, data: any) =>
    api(`/hospital/equipment/${encodeURIComponent(id)}`, {
      method: "PUT",
      body: JSON.stringify(data),
    }),
  deleteEquipment: (id: string) =>
    api(`/hospital/equipment/${encodeURIComponent(id)}`, { method: "DELETE" }),

  listEquipmentPPM: (params?: {
    equipmentId?: string;
    from?: string;
    to?: string;
    page?: number;
  ...
  createEquipmentPPM: (data: {
    ...
    api("/hospital/equipment/ppm", {
      method: "POST",
      body: JSON.stringify(data),
    }),

  listEquipmentCalibrations: (params?: {
    equipmentId?: string;
    from?: string;
    to?: string;
    page?: number;
  ...
  createEquipmentCalibration: (data: {
    equipmentId: string;
    performedAt: string;
    nextDue?: string;
    labName?: string;
    ...
    api("/hospital/equipment/calibrations", {
      method: "POST",
      body: JSON.stringify(data),
    }),
  ...
  listEquipmentBreakdowns: (params?: {
    equipmentId?: string;
    status?: "Open" | "Closed";
    from?: string;
    to?: string;
  ...
  createEquipmentBreakdown: (data: {
    ...
    api("/hospital/equipment/breakdowns", {
      method: "POST",
      body: JSON.stringify(data),
    }),
  updateEquipmentBreakdown: (
    ...
    api(`/hospital/equipment/breakdowns/${encodeURIComponent(id)}`, {
      method: "PUT",
      body: JSON.stringify(data),
    }),

  // Equipment: Condemnations
  listEquipmentCondemnations: (params?: {
    equipmentId?: string;
  ...
  createEquipmentCondemnation: (data: {
    equipmentId: string;
    proposedAt?: string;
    reason?: string;
    approvedBy?: string;
    ...
    api("/hospital/equipment/condemnations", {
      method: "POST",
      body: JSON.stringify(data),
    }),
  updateEquipmentCondemnation: (
    id: string,
    data: Partial<{
      proposedAt?: string;
      reason?: string;
    ...
    api(`/hospital/equipment/condemnations/${encodeURIComponent(id)}`, {
      method: "PUT",
      body: JSON.stringify(data),
    }),
...
export const financeApi = {
  ...
  openCashSession: (data: {
    ...
    api("/hospital/finance/cash-sessions/open", {
      method: "POST",
      body: JSON.stringify(data),
    }),
  closeCashSession: (
    ...
    api(`/hospital/finance/cash-sessions/${encodeURIComponent(id)}/close`, {
      method: "POST",
      body: JSON.stringify(data),
    }),
  ...
  createCashCount: (data: {
    ...
    api("/hospital/finance/cash-counts", {
      method: "POST",
      body: JSON.stringify(data),
    }),
  deleteCashCount: (id: string) =>
    api(`/hospital/finance/cash-counts/${encodeURIComponent(id)}`, {
      method: "DELETE",
    }),
  cashCountSummary: (params?: {
    from?: string;
  ...
  createVendor: (data: { name: string; phone?: string; address?: string }) =>
    api("/hospital/finance/vendors", {
      method: "POST",
      body: JSON.stringify(data),
    }),
  updateVendor: (
    ...
    api(`/hospital/finance/vendors/${encodeURIComponent(id)}`, {
      method: "PUT",
      body: JSON.stringify(data),
    }),
  ...
  balanceSheet: (asOf?: string) =>
    api(
      `/hospital/finance/balance-sheet${asOf ? `?asOf=${encodeURIComponent(asOf)}` : ""}`,
    ),
  ...
  recurringCreate: (data: {
    ...
    api("/hospital/finance/recurring", {
      method: "POST",
      body: JSON.stringify(data),
    }),
  recurringUpdate: (
    ...
    api(`/hospital/finance/recurring/${encodeURIComponent(id)}`, {
      method: "PUT",
      body: JSON.stringify(data),
    }),
  recurringDelete: (id: string) =>
    api(`/hospital/finance/recurring/${encodeURIComponent(id)}`, {
      method: "DELETE",
    }),
  recurringRun: (id: string) =>
    api(`/hospital/finance/recurring/${encodeURIComponent(id)}/run`, {
      method: "POST",
    }),
  ...
  updateUser: (
    ...
    api(`/hospital/finance/users/${encodeURIComponent(id)}`, {
      method: "PUT",
      body: JSON.stringify(data),
    }),
  deleteUser: (id: string) =>
  ...
  // Finance Module: Auth
  login: (username: string, password: string) =>
    api("/hospital/finance/users/login", {
      method: "POST",
      body: JSON.stringify({ username, password }),
    }),
  logout: () => api("/hospital/finance/users/logout", { method: "POST" }),
  ...
  createSidebarRole: (
    ...
    api("/hospital/finance/sidebar-roles", {
      method: "POST",
      body: JSON.stringify({ role, permissions }),
    }),
  deleteSidebarRole: (role: string) =>
    api(`/hospital/finance/sidebar-roles/${encodeURIComponent(role)}`, {
      method: "DELETE",
    }),
  listSidebarPermissions: (role?: string) =>
    role
      ? api(
          `/hospital/finance/sidebar-permissions?role=${encodeURIComponent(role)}`,
        )
  ...
  updateSidebarPermissions: (
    ...
    api(`/hospital/finance/sidebar-permissions/${encodeURIComponent(role)}`, {
      method: "PUT",
      body: JSON.stringify(data),
    }),
  resetSidebarPermissions: (role: string) =>
    api(
      `/hospital/finance/sidebar-permissions/${encodeURIComponent(role)}/reset`,
      { method: "POST" },
    ),
  ...
  createAuditLog: (data: {
    ...
    api("/hospital/finance/audit-logs", {
      method: "POST",
      body: JSON.stringify(data),
    }),
};
...
export const aestheticFinanceApi = {
  manualDoctorEarning: (data: {
    ...
    api("/aesthetic/finance/manual-doctor-earning", {
      method: "POST",
      body: JSON.stringify(data),
    }),
  doctorPayout: (data: {
    ...
    api("/aesthetic/finance/doctor-payout", {
      method: "POST",
      body: JSON.stringify(data),
    }),
  doctorBalance: (doctorId: string) =>
  ...
  doctorPayouts: (doctorId: string, limit?: number) =>
    api(
      `/aesthetic/finance/doctor/${encodeURIComponent(doctorId)}/payouts${limit ? `?limit=${limit}` : ""}`,
    ),
  doctorEarnings: (params?: {
    doctorId?: string;
    from?: string;
  ...
  reverseJournal: (journalId: string, memo?: string) =>
    api(`/aesthetic/finance/journal/${encodeURIComponent(journalId)}/reverse`, {
      method: "POST",
      body: JSON.stringify({ memo }),
    }),
  payablesSummary: () => api("/aesthetic/finance/payables-summary"),
  listRecentPayouts: (limit?: number) =>
    api(`/aesthetic/finance/payouts${limit ? `?limit=${limit}` : ""}`),
};
