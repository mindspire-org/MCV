...
const defaultSidebarItems = [
  ...
  { path: '/aesthetic/doctor-finance', label: 'Doctor Finance', order: 14 },
  { path: '/aesthetic/doctor-payouts', label: 'Doctor Payouts', order: 15 },
  { path: '/aesthetic/audit-logs', label: 'Audit Logs', order: 16 },
  { path: '/aesthetic/user-management', label: 'User Management', order: 17 },
  { path: '/aesthetic/notifications', label: 'Notifications', order: 18 },
  { path: '/aesthetic/consent-templates', label: 'Consent Templates', order: 19 },
  { path: '/aesthetic/sidebar-permissions', label: 'Sidebar Permissions', order: 20 },
  { path: '/aesthetic/settings', label: 'Settings', order: 21 },
]
